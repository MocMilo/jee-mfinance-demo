...
import com.infoshare.mfinance.core.analyzer.Analysis;
import com.infoshare.mfinance.core.analyzer.IResult;
...
public class InvestmentIndicator extends Analysis implements IResult {
    private static final Logger LOGGER = LoggerFactory.getLogger(InvestmentIndicator.class);
