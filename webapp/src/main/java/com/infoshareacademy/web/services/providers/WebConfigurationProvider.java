...
import com.infoshareacademy.web.utils.filereaders.ResourceFileReader;
...
public class WebConfigurationProvider {
    ...
    public WebConfiguration getWebConfigurationFromResources() {
        try {
            ...
            String content = new ResourceFileReader(Paths.get(targetFile.getAbsolutePath()))
                    .getFileAsString();
    ...
    public WebConfiguration getWebConfigurationFromExternalSource() {
        try {
            ...
            String content = new ResourceFileReader(externalJsonFilePath)
                    .getFileAsString();
